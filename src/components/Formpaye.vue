...
<template>
    <div class="flex flex-wrap justify-between md:justify-center  md:gap-20 ">
        ...
        <div class="">
            ...
            <FormKit type="form" v-model="montre" submit-class="bg-Color-Bluefoncé px-8 rounded-lg py-4 text-white" submit-label="Payer"   @submit="openModal"  :submit-attrs="{ classes: { input: 'bg-Color-Bluefoncé px-8 rounded-lg py-4 text-white '} }"  >
                  ...
                  >
                    <div class="mt-2">
                      <p class="text-xl text-white text-center py-5 ">
                        Vous recevrez votre montre dans 5 jours
                      </p>
                    </div>
